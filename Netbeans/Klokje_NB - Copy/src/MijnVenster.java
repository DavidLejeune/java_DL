...
public class MijnVenster extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LinksPaneel = new javax.swing.JPanel();
        ...
        LinksPaneel.setBackground(new java.awt.Color(0, 0, 0));

        javax.swing.GroupLayout LinksPaneelLayout = new javax.swing.GroupLayout(LinksPaneel);
        LinksPaneel.setLayout(LinksPaneelLayout);
        LinksPaneelLayout.setHorizontalGroup(
            LinksPaneelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 100, Short.MAX_VALUE)
        );
        LinksPaneelLayout.setVerticalGroup(
            LinksPaneelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 548, Short.MAX_VALUE)
        );

        jPanel1.add(LinksPaneel, java.awt.BorderLayout.LINE_START);
        ...
        btnStartServer.setFont(new java.awt.Font("OCR A Extended", 0, 18)); // NOI18N
        ...
        btnAdToLog.setFont(new java.awt.Font("OCR A Extended", 0, 18)); // NOI18N
        ...
        btnAdToLog1.setFont(new java.awt.Font("OCR A Extended", 0, 18)); // NOI18N
        ...
        bntSearch.setFont(new java.awt.Font("OCR A Extended", 0, 18)); // NOI18N
                    ...
                    .addGroup(CenterPaneelLayout.createSequentialGroup()
                        .addGroup(CenterPaneelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(CenterPaneelLayout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(CenterPaneelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtJaar, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel4)))
                            .addComponent(jLabel5))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(CenterPaneelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(bntSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnAdToLog)))
                    .addGroup(CenterPaneelLayout.createSequentialGroup()
                ...
                .addGroup(CenterPaneelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(CenterPaneelLayout.createSequentialGroup()
                        ...
                        .addGroup(CenterPaneelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(btnAdToLog, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
  ...
  public static void slaap (int millseconds){		 
    ...
    private javax.swing.JPanel LinksPaneel;
    ...
    // geen constructor nodig --> automatic default constructor
  	...
  	public void run(){
  	  ...
  	  while (true){
            ...
            g5.drawOval(190, 723, 100, 100); 

             Graphics2D g10 = (Graphics2D) getGraphics();
            g10.setColor(Color.DARK_GRAY);
            g10.drawOval(810, 723, 100, 100); 
...
//            g.drawOval(700, 680, 150, 150); 
		...
		lblUur.setText("" + String.format("%02d", uren) + ":"+ String.format("%02d", minuten) + ":"+ String.format("%02d", seconden)) ;
            ...
            g3.fillArc(510, 723, 100, 100,92 - (15 * uren),2)  ;  
            
            Graphics2D g2 = (Graphics2D) getGraphics();
            g2.setColor(Color.BLUE);
            g2.fillArc(510, 723, 100, 100,92 - (6*minuten),2)  ;  
                             
            Graphics2D g = (Graphics2D) getGraphics();
            g.setColor(Color.YELLOW);
            g.fillArc(510, 723, 100, 100,92 - (6*seconden),2)  ;  
                  
                  
            Graphics2D g6 = (Graphics2D) getGraphics();
            g6.setColor(Color.WHITE);
            g6.fillArc(190, 723, 100, 100,92 + (15*urenW),2)  ;  
            
            Graphics2D g7 = (Graphics2D) getGraphics();
            g7.setColor(Color.BLUE);
            g7.fillArc(190, 723, 100, 100,92 - (6*minuten),2)  ;  
                             
            Graphics2D g8 = (Graphics2D) getGraphics();
            g8.setColor(Color.YELLOW);
            g8.fillArc(190, 723, 100, 100,92 - (6*seconden),2)  ;  
            
            
            Graphics2D g11 = (Graphics2D) getGraphics();
            g11.setColor(Color.WHITE);
            g11.fillArc(810, 723, 100, 100,92 - (15*urenR),2)  ;  
            
            Graphics2D g12 = (Graphics2D) getGraphics();
            g12.setColor(Color.BLUE);
            g12.fillArc(810, 723, 100, 100,92 - (6*minuten),2)  ;  
                             
            Graphics2D g13 = (Graphics2D) getGraphics();
            g13.setColor(Color.YELLOW);
            g13.fillArc(810, 723, 100, 100,92 - (6*seconden),2)  ;  

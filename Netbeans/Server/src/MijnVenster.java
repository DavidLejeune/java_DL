...
public class MijnVenster extends javax.swing.JFrame {
	...
	klokje = new Klokske(lblUur,lblUur1,lblUur2,jPanel1);
	klokje.start();
        lijst = new ArrayList<>();
        ...
        ImportDatabase id = new ImportDatabase(txtDatabase,lblDatabase);      
        id.start();
        lblResult.hide();
        jLabel5.hide();
        txtLocation.hide();
    ...
    private void initComponents() {
        ...
        jLabel15.setFont(new java.awt.Font("Magneto", 0, 47)); // NOI18N
        ...
        ZuidPaneelLayout.setHorizontalGroup(
            ...
            .addComponent(jTextField1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1129, Short.MAX_VALUE)
        ...
        RechtsPaneelLayout.setHorizontalGroup(
            ...
            .addGroup(RechtsPaneelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(RechtsPaneelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
        ...
        btnSaveLog.setBackground(new java.awt.Color(0, 0, 255));
        btnSaveLog.setFont(new java.awt.Font("OCR A Extended", 0, 14)); // NOI18N
        btnSaveLog.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void btnAdToLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdToLogActionPerformed
        ...
        //hier voegen we het toe aan de database.csv
        BufferedWriter uit;
	...
	cd = Calendar.getInstance();
        ...
        lblResult.setText("<html>Bestand <b><i>" + bestandnaam + " </i></b>werd aangemaakt om " +  String.format("%02d", uren) + 
            ...
            g99.drawString("Bestand " + bestandnaam + " werd aangepast om " +  String.format("%02d", uren) + 
                ":"+ String.format("%02d", minuten) + ":"+ String.format("%02d", seconden), 200, 680);
            g99.drawRect(190, 655,730,35);
        ...
        repaint();
         ...
         //hier laden we het database bestand terug in                       
        ImportDatabase id = new ImportDatabase(txtDatabase,lblDatabase);      
        id.start();
...
//        kms = new KKMultiServer(txtServer,txtDatabase,lblDatabase,txtNaam,txtKlas,txtJaar,task,jPanel1);      
//        kms.start();
